defmodule PhxTutorial.OrdersTest do
  use PhxTutorial.DataCase

  alias PhxTutorial.Orders

  describe "orders" do
    alias PhxTutorial.Orders.Order

    import PhxTutorial.OrdersFixtures
  ...
  describe "order_line_items" do
    alias PhxTutorial.Orders.LineItem
