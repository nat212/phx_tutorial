defmodule PhxTutorial.CatalogTest do
  use PhxTutorial.DataCase

  alias PhxTutorial.Catalog

  describe "products" do
    alias PhxTutorial.Catalog.Product

    import PhxTutorial.CatalogFixtures
  ...
  describe "categories" do
    alias PhxTutorial.Catalog.Category
