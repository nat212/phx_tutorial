defmodule PhxTutorial.ShoppingCartTest do
  use PhxTutorial.DataCase

  alias PhxTutorial.ShoppingCart

  describe "carts" do
    alias PhxTutorial.ShoppingCart.Cart

    import PhxTutorial.ShoppingCartFixtures
  ...
  describe "cart_items" do
    alias PhxTutorial.ShoppingCart.CartItem
