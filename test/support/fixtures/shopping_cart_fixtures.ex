defmodule PhxTutorial.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `PhxTutorial.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> PhxTutorial.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> PhxTutorial.ShoppingCart.create_cart_item()
